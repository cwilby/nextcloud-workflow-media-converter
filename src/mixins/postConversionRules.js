export default {
	data: () => ({
		postConversionSourceRules: [
			...
			{ id: 'move', label: t('workflow_media_converter', 'Move the source file to a specific folder') },
		],
		...
		postConversionOutputConflictRules: [
			...
			{ id: 'move', label: t('workflow_media_converter', 'Move the existing file to a specific folder') },
		],
	}),
}
