OC.L10N.register(
    ...
    "Additional FFmpeg flags (optional, leave blank to use defaults)" : "علامات FFmpeg إضافية (إختيارياً، يمكنك ترك الخانة فارغة لاعتماد القيم التلقائية)",
    "Save" : "حفظ",
    ...
    "Move source file to specific folder" : "أُنقُل الملف المصدر إلى مُجلّد مُعيّن",
    "Store output in source folder" : "خزّن المخرجات في المُجلّد المصدر",
    "Move output to specific folder" : "أُنقُل المُخرجات إلى مُجلّد مُعيّن",
    ...
    "Move existing file to specific folder" : "أُنقُل الملف الموجود إلى مُجلّد مُعيّن",
